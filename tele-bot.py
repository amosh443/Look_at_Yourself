...
def welcome(user):
    ...
    msg('Вам будут приходить сообщения-напоминания о необходимости выполнения определенных практик. 💬\n\nКаждый день у '
        ...
        'школе Пифагора.\nПомимо основных трех практик будут дополнительные по ходу дня (они не занимают много '
...
def after_settings(user):
    ...
    msg('Наше первое задание – определиться с тем, насколько мы внимательны в повседневной жизни. ✅\nДавайте ответим '
        ...
        'определить для себя области, которые нуждаются в изменениях и области, где мы ждем.\n')
